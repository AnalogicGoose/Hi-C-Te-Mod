...
@Mod("hic_te")
public class HicTeMod {
	public static final Logger LOGGER = LogManager.getLogger(HicTeMod.class);
	public static final String MODID = "hic_te";
	...
	public HicTeMod() {
		...
		HicTeModEntities.REGISTRY.register(bus);
